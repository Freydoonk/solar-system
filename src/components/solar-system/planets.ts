...
// slower factor: multiply all periods by this (bigger = slower)
const SLOW_FACTOR = 4.5;
...
export const PLANET_PRESETS: PlanetPreset[] = [
  {
    ...
    radiusPx: 6,
    orbitAUScaled: 0.39,
    orbitPeriodSec: 3.0 * SLOW_FACTOR,
    eccentricity: 0.2056,
    phaseRad: 0.2,
    className: "mercury",
    showOrbit: true,
  },
  {
    ...
    radiusPx: 9,
    orbitAUScaled: 0.72,
    orbitPeriodSec: 4.8 * SLOW_FACTOR,
    eccentricity: 0.0068,
    phaseRad: 1.1,
    className: "venus",
    showOrbit: true,
  },
  {
    ...
    radiusPx: 10,
    orbitAUScaled: 1.0,
    orbitPeriodSec: 6.5 * SLOW_FACTOR,
    eccentricity: 0.0167,
    phaseRad: 2.4,
    className: "earth",
    showOrbit: true
  ...
  // (Real eccentricity is ~0.055; good enough.)
  {
    ...
    radiusPx: 4,
    orbitAUScaled: 0,
    orbitPeriodSec: 2.2 * SLOW_FACTOR,
    eccentricity: 0.055,
    phaseRad: 0.0,
    className: "moon",
    showOrbit: true
...

  {
    ...
    radiusPx: 8,
    orbitAUScaled: 1.52,
    orbitPeriodSec: 8.5 * SLOW_FACTOR,
    eccentricity: 0.0934,
    phaseRad: 0.7,
    className: "mars",
    showOrbit: true,
  },
  {
    ...
    radiusPx: 18,
    orbitAUScaled: 5.20,
    orbitPeriodSec: 18.0 * SLOW_FACTOR,
    eccentricity: 0.0489,
    phaseRad: 2.9,
    className: "jupiter",
    showOrbit: false,
  },
  {
    ...
    radiusPx: 16,
    orbitAUScaled: 9.58,
    orbitPeriodSec: 25.0 * SLOW_FACTOR,
    eccentricity: 0.0565,
    phaseRad: 1.8,
    className: "saturn",
    showOrbit: false,
  },
  {
    ...
    radiusPx: 14,
    orbitAUScaled: 19.2,
    orbitPeriodSec: 35.0 * SLOW_FACTOR,
    eccentricity: 0.0472,
    phaseRad: 0.4,
    className: "uranus",
    showOrbit: false,
  },
  {
    ...
    radiusPx: 14,
    orbitAUScaled: 30.05,
    orbitPeriodSec: 45.0 * SLOW_FACTOR,
    eccentricity: 0.0086,
    phaseRad: 2.1,
    className: "neptune",
    showOrbit: false
  ...
  // Pluto (dwarf planet) — included per your request
  {
    ...
    radiusPx: 5,
    orbitAUScaled: 39.48,
    orbitPeriodSec: 55.0 * SLOW_FACTOR,
    eccentricity: 0.2488,
    phaseRad: 1.6,
    className: "pluto",
    showOrbit: false
